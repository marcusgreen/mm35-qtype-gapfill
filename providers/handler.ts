...
/**
 * Handler to support Gapfill question type.
 */
@Injectable()
export class AddonQtypeGapfillHandler implements CoreQuestionHandler {
    name = 'AddonQtypeGapfill';
    type = 'qtype_gapfill';
    ...
    getComponent(injector: Injector, question: any): any | Promise<any> {
        return AddonQtypeGapfillComponent;
    }
